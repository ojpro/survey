  ...
  return (
    <>
      ...
      <div className="min-h-full container mx-auto p-1">
        ...
        {/* Navbar */}
        <div className="navbar bg-blue-400 m-3 rounded-full px-8">
          <div className="navbar-start">
            <div className="dropdown">
              <label tabIndex={0} className="btn btn-ghost focus:bg-blue-500 lg:hidden text-white">
                ...
                {navigation.map((item, index) => (
                  <li key={index}>
                    <NavLink
                      key={item.name}
                      to={item.to}
                      className={({isActive}) => classNames('focus:bg-blue-500 focus:text-white')}
              ...
              {navigation.map((item, index) => (
                <li key={index}>
                  <NavLink
                    key={item.name}
                    to={item.to}
                    className={({isActive}) => classNames('focus:bg-blue-500 text-white')}
                    aria-current={item.current ? 'page' : undefined}
                  >
                    {item.name}
                  </NavLink>
